# [Week 2] Image Formation 실습 리뷰 및 코드 분석

2주차 컴퓨터 비전 실습에서는 카메라의 기하학적 특성을 이해하고, 이미지를 변환하며, 스테레오 비전을 통해 3D 깊이(Depth)를 추정하는 세 가지 핵심 과제를 수행했습니다. 각 과제별 작성된 코드의 논리와 OpenCV 핵심 함수들을 분석합니다.
