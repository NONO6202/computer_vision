...
<img width="1200" height="500" alt="Figure_1" src="https://github.com/user-attachments/assets/b5c0c449-18cc-4675-ba66-9dd70065c84d" />
...
<img width="1400" height="500" alt="Figure_2" src="https://github.com/user-attachments/assets/95eb47d5-9dee-4516-8de3-7c846e052d24" />
...
lines = cv.HoughLinesP(  # 확률적 허프 변환으로 직선 성분을 검출한다.
    ...
    105,  # 누적 투표 임계값을 105으로 설정해 구조물의 대표 직선을 안정적으로 찾는다.
    minLineLength=50,  # 최소 직선 길이를 50픽셀로 설정해 짧은 잡음을 줄인다.
    maxLineGap=12,  # 같은 직선으로 볼 수 있는 최대 간격을 12픽셀로 설정한다.
) 
...
<img width="1800" height="600" alt="Figure_3" src="https://github.com/user-attachments/assets/3bd8c9b3-fb37-45c7-846f-96302b48c791" />
